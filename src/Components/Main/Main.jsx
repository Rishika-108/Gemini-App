    ...
    <div className='main'>
        ...
        <div className="main-container">
            ...
            <div className="cards">
                ...
                <div className="card">
                    <p onClick={ ()=>onSent("Briefly summarise this concept: urban planning")}>Briefly summarise this concept: urban planning</p>
                ...
                <div className="card">
                    <p onClick={ ()=>onSent("Improve the readibilty of the following code")}>Improve the readibilty of the following code</p>
